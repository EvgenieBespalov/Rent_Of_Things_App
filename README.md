...
Экраны авторизации и регистрации соответственно. Без заполнения обязательных полей кнопки входа и регистрации недоступны. Реализованы проверки на корректность ввода данных, при их соответствии поля окрашиваются в оранжевый, иначе они серые.<br>
<p align="center">
